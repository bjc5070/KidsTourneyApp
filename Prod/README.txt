...
**IMPORTANT**
IF ANY AGE GROUP ONLY HAS ONE CONTESTANT THE SCRIPT WILL BREAK. FIX THIS FOR 2023
Update Entry will over right entire database row. be sure to add all information for that contestant to perform the update. (except zeros)
